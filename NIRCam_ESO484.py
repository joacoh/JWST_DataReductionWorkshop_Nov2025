...
target = 'ESO484'
#obs_list = ['02102', '02102long', '02104', '02104long', '03101', '03101long', '03103', '03103long']
obs_list = ['03101', '03103']
#obs_list = ['02102']
...
for obs in obs_list:
    ...
    raw_dir = file_dir / f"{target}/NIRCam/{obs}/raw"
    reduced_dir = file_dir / f"{target}/NIRCam/{obs}/reduced"
    finals_dir = file_dir / f"{target}/NIRCam/finals"
    ...
    for stage in [1, 2, 3]:
        src = file_dir / f"{target}/NIRCam/stage{stage}_params.asdf"
